...
$firstname = $name = $address = $zipcode = $city = $email = $salary = "";
$firstname_err = $name_err = $address_err = $zipcode = $city = $email = $salary_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($firstname_err) && empty($name_err) && empty($address_err) && empty($zipcode_err) && empty($city_err) && empty($email_err) && empty($salary_err)){
        // Prépare une déclaration d'insertion
        $sql = "INSERT INTO managers (firstname, name, address, zipcode, city, email, salary) VALUES (:firstname, :name, :address, :zipcode, :city, :email, :salary)";
