...
$info=$_POST['info'];
$info=$_POST['info'];
$sql="INSERT INTO  pages(FullName,EmailId,MobileNumber,Subject,Description) VALUES(:fname,:email,:mobile,:subject,:description)";
    ...
    <main class="main">
      ...
      <div class="container-fluid p-0">
        ...
        <div class="card-header shadow-lg border-top mb-5 mx-auto">
          <h1>Hypnos <?php echo htmlentities($result->resortname);?></h1>
        </div>
      </div>
